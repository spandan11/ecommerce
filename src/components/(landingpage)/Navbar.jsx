            ...
            <div className="container mx-auto flex flex-wrap px-5 py-3 flex-row items-center justify-around">
                ...
                <form className='hidden md:block md:m-auto md:pl-2 md:w-2/5'>
                    ...
                    <div className="relative">
                        ...
                        <button type="submit" className="text-white absolute right-2.5 bottom-2.5 bg-indigo-600 hover:bg-indigo-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Search</button>
                    </div>
                </form>
                <div className='flex items-center gap-2'>
                    ...
                    <Link href={`/${session?.data ? session?.data?.user?.role : 'user'}`} className='p-1'>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
